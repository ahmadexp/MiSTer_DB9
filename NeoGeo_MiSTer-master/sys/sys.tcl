...
set_location_assignment PIN_AG16 -to joy_splitter_select
set_location_assignment PIN_AG11 -to joy_select
...
#set_instance_assignment -name IO_STANDARD "3.3-V LVTTL" -to joy_splitter_select
#set_instance_assignment -name IO_STANDARD "3.3-V LVTTL" -to joy_select
