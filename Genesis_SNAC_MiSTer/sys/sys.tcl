...
set_location_assignment PIN_AF17 -to USER_IO[6]
set_location_assignment PIN_AH9  -to USER_IO[5]
set_location_assignment PIN_AG11 -to USER_IO[4]
set_location_assignment PIN_AH12 -to USER_IO[3]
set_location_assignment PIN_AH11 -to USER_IO[2]
set_location_assignment PIN_AF15 -to USER_IO[1]
set_location_assignment PIN_AE15 -to USER_IO[0]
